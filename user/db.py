...
def getUser(user=None,server=None):
    if user:
        ...
        response = requests.post(server+"/api/auth/getUser",headers=headers)
        if response.status_code == 200:
            return response.json()
        return response.json()
    return {}
...
def getBookings(user=None,server=None):
    if user:
        ...
        response = requests.post(server+"/api/models/user/getBookings",headers=headers)
        #print(response)
        if response.status_code == 200:
            return response.json()
        return response.json()
...
def deleteBooking(server=None,user=None,book=None):
    if user:
        ...
        response = requests.post(server+"/api/models/user/deleteBook/"+book,headers=headers)
        if response.status_code == 200:
            return response.json()
        return response.json()
...
def getBooking(server=None,user=None,book=None):
    if user:
        ...
        response = requests.post(server+"/api/models/user/getBook/"+book,headers=headers)
        if response.status_code == 200:
            return response.json()
...
def getInvoice(server=None,user=None,id=None):
    if user:
        ...
        response = requests.post(server+"/api/models/user/getInvoice/"+id,headers=headers)
        if response.status_code == 200:
            return response.json()
        print(response,response.json())
        return response.json()